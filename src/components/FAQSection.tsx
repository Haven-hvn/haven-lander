...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Absolutely. With client-side encryption, your content is encrypted before upload using keys that only you control. The encrypted data is stored on a verifiable network where its location and integrity are constantly proven, but without your authorization, it remains unreadable. ',
  },
  {
